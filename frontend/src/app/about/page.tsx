...
//             <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-sm font-medium text-white backdrop-blur-md">
...
//           <div className="grid overflow-hidden rounded-[2rem] bg-slate-950 lg:grid-cols-2">
...
//                   <div className="absolute bottom-5 left-5 flex h-11 w-11 items-center justify-center rounded-xl bg-white text-slate-900 shadow-lg">
//                     <Icon size={21} />
//                   </div>
...
//               <p className="text-3xl font-semibold">$300M</p>
...
//                 target="_blank"
//                 rel="noreferrer"
//                 className="group flex items-center justify-between rounded-3xl border border-slate-200 bg-white p-6 transition hover:border-emerald-300 hover:shadow-lg"
//               >

//                 <div className="flex items-center gap-5">

//                   <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-slate-100 text-lg font-bold text-slate-900">
...
//                   <Zap className="text-emerald-400" size={23} />
...
//                 <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
//                   <Wind className="text-emerald-400" size={23} />
...
//         <div className="mx-auto max-w-5xl overflow-hidden rounded-[2rem] bg-emerald-500 px-8 py-16 text-center sm:px-16 lg:py-20">
